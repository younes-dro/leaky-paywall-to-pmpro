 ...
 * @subpackage Ets_Leaky_To_Pmpro/public
 */
 ...
 */
class Ets_Leaky_To_Pmpro_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/ets-leaky-to-pmpro-public.css', array(), $this->version, 'all' );
